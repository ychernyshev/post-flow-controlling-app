...
<!--      <span>Поштові відправлення</span>-->
<!--      <router-link to="/add_entry" class="link-secondary" aria-label="Add a new report">-->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/dashboard.html">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...alt...">
        <span class="ms-1 font-weight-bold">Post-Flow Controlling Appgit</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <router-link to="/streets" class="nav-link" active-class="active">
            ...
            <span class="nav-link-text ms-1">Streets</span>
          </router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3 d-flex flex-row">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Поштові відправлення</h6>
          <router-link to="/add_entry" class="link-secondary" aria-label="Add a new report">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle align-text-bottom" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/entries_history" class="nav-link" active-class="active">
            ...
            <span class="nav-link-text ms-1">Історія ПВ</span>
          </router-link>
        </li>
...
<!--        </li>-->
        <li class="nav-item">
          <router-link to="/add_entry" class="nav-link" active-class="active">
            ...
            <span class="nav-link-text ms-1">Додати ПВ</span>
          </router-link>
        </li>
      </ul>
    </div>
    <div class="sidenav-footer mx-3 mt-3 pt-3">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-left p-3 w-100">
          ...
          <div class="docs-info">
            <h6 class="text-white up mb-0">З'явилися питання?</h6>
            <p class="text-xs font-weight-bold">Знайди відповідь у документації</p>
            <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Документація</a>
          </div>
        </div>
      </div>
    </div>
